...
function resize(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var width, height, originalImagePath, thumnailPath, thumWidth, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    thumnailPath = path_1.default.resolve("assets/thumnail/".concat(req.query.fname, ".jpg"));
                    if (width) {
                        width = Number(width);
                    }
                    if (height) {
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(thumnailPath).metadata()];
                case 1: return [4 /*yield*/, (_a.sent()).width];
                case 2:
                    thumWidth = _a.sent();
                    if (!(fs_1.default.existsSync(thumnailPath) && thumWidth === width)) return [3 /*break*/, 3];
                    res.status(200).sendFile(path_1.default.resolve(thumnailPath));
                    return [3 /*break*/, 9];
                case 3:
                    if (!fs_1.default.existsSync(originalImagePath)) return [3 /*break*/, 8];
                    _a.label = 4;
                case 4:
                    _a.trys.push([4, 6, , 7]);
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(fpath)
                            .resize(width, height)
                            .toFile(path_1.default.resolve("assets/thumnail/".concat(filename)))];
                case 1:
                    _a.sent();
                    _a.label = 2;
