        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    cropedPath = path_1.default.resolve("assets/cuted/".concat(req.query.fname, "_").concat(width, "_").concat(height, ".").concat(format || 'jpg'));
                    if (width) {
                        width = Number(width);
                    }
                    if (height) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, cropImage((0, resize_1.imageExist)(originalImagePath), width, height, left, top, format)];
                case 3:
                    _a.sent();
...
function cropImage(fpath, width, height, left, top, format) {
    return __awaiter(this, void 0, void 0, function () {
        var filename;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, sharp_1.default)(fpath)
                            ...
                            .toFormat(format || 'jpg')
                            .toFile(path_1.default.resolve("assets/croped/".concat(filename, "_").concat(width, "_").concat(height, ".").concat(format || 'jpg')))];
                case 1:
                    _a.sent();
                    _a.label = 2;
